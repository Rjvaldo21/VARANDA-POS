...
const canCreateUsers = computed(() => {
  return currentUser.value.profile?.can_manage_users || true
})
...
onMounted(async () => {
  await Promise.all([
    api.get('store-profile/').then(res => {
    ...
    <div class="p-4">
      ...
      <div class="mb-6 flex flex-wrap items-center gap-4">
        ...
        <div class="form-group mb-0">
          ...
          <select v-model="roleFilter" class="border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
      ...
      <div class="overflow-x-auto border border-gray-300 rounded-lg">
        <table class="w-full border-collapse text-sm">
          <thead class="bg-gray-50">
            <tr>
              <th class="border-b border-gray-200 px-4 py-3 text-left font-medium text-gray-700">User</th>
              <th class="border-b border-gray-200 px-4 py-3 text-left font-medium text-gray-700">Role</th>
              ...
              <th class="border-b border-gray-200 px-4 py-3 text-left font-medium text-gray-700">Last Login</th>
              <th v-if="canManageUsers" class="border-b border-gray-200 px-4 py-3 text-left font-medium text-gray-700">Actions</th>
            </tr>
          </thead>
            ...
            <tr v-for="user in filteredUsers" :key="user.id" class="hover:bg-gray-50">
              <td class="px-4 py-3">
                <div class="flex items-center">
                  <div class="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center mr-3 text-sm font-medium">
              ...
              <td class="px-4 py-3">
                ...
                >
                  {{ user.profile?.role_display || user.profile?.role || 'No Role' }}
                </span>
              </td>
              <td class="px-4 py-3">
                <div>
              ...
              <td v-if="canManageUsers" class="px-4 py-3">
      ...
      <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4">
        <div class="flex items-center justify-between p-6 border-b border-gray-200">
          <h3 class="text-lg font-semibold">
            User Permissions - {{ selectedUser?.first_name }} {{ selectedUser?.last_name }}
          </h3>
        ...
        <div class="p-6">
          <div class="mb-4">
            <div class="flex items-center">
              ...
              >
                {{ selectedUser?.profile?.role_display || selectedUser?.profile?.role || 'No Role' }}
              </span>
            </div>
        ...
        <div class="px-6 py-4 border-t border-gray-200">
          <button @click="closePermissionsModal" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors">
            Close
          </button>
        </div>
      </div>
