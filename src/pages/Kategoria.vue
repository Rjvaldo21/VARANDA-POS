...
<template>
  <div class="bg-white border border-gray-50 rounded-sm shadow text-sm flex flex-col h-full">
    ...
    <div class="flex items-center gap-2 p-2 border-b border-gray-300 bg-gray-50">
      ...
      />
      <h1 class="text-lg font-semibold">CATEGORY MANAGEMENT</h1>
    </div>
      ...
      <div class="overflow-x-auto border border-gray-300 rounded-lg">
        <table class="w-full border-collapse text-sm">
          <thead class="bg-gray-50">
            <tr>
              <th class="border-b border-gray-200 px-4 py-3 text-left font-medium text-gray-700">Category Name</th>
              <th class="border-b border-gray-200 px-4 py-3 text-left font-medium text-gray-700">Category Code</th>
              <th class="border-b border-gray-200 px-4 py-3 text-left font-medium text-gray-700">Actions</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-gray-200">
            <tr v-if="loading">
              <td colspan="3" class="px-4 py-8 text-center text-gray-500">Loading categories...</td>
            </tr>
            ...
            <tr v-else v-for="category in filteredCategories" :key="category.id" class="hover:bg-gray-50" 
                :class="{ 'bg-blue-50': selectedKategori?.id === category.id }"
                @click="selectedKategori = category">
              <td class="px-4 py-3">
            ...
            <div class="space-y-6">
              ...
              <div class="space-y-1">
                ...
                <input 
                  ...
                  required
                />
                <p class="text-sm text-gray-500">Name of the product category</p>
              </div>
              ...
              <div class="space-y-1">
                ...
                <input 
                  ...
                  type="text"
                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                  placeholder="Enter category code (e.g., FOOD, BVRG)"
                  required
                />
                <p class="text-sm text-gray-500">Unique identifier for the category</p>
              </div>
            </div>
          </div>
